...
class SwaggerConfig {
    ...
    private fun servers(): List<Server> {
        return listOf(
            ...
            Server().url("https://dev.hoji.com").description("Dev Server"),
            Server().url("https://api.hoji.com").description("Production Server")
        )
    }
