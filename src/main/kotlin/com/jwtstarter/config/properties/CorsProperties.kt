...
/**
 * CORS 설정 프로퍼티 (application*.yml의 `jwtstarter.cors.*`).
 *
 ...
 */
@ConfigurationProperties(prefix = "jwtstarter.cors")
data class CorsProperties(
    ...
    fun validate() {
        require(!(allowCredentials && hasWildcardOrigin())) {
            "jwtstarter.cors: allowCredentials=true와 allowedOrigins '$WILDCARD'는 동시 사용 불가. " +
                "허용 오리진을 명시하세요."
        }
    }
